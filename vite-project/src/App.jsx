...
export default function App() {
    ...
    return (
        <>
            ...
            <nav>
                <input onChange={(e) => setListTerrorists(terrorists.map((person) => {person.name.includes(e)}))} type="text" placeholder='search by name' />
